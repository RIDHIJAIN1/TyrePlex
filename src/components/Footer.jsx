  ...
  <div className="container mx-auto flex flex-wrap justify-between items-start">
    ...
    <div className="w-full md:w-1/4 mb-6 md:mb-0">
      ...
      <div className="flex  space-x-5 mb-6">
          <a href="#" className="text-xl text-gray-400 hover:text-white transition border-red-500 border-2 p-2">
            <FaFacebookF />
          </a>
          <a href="#" className="text-xl text-gray-400 hover:text-white transition  border-red-500 border-2 p-2">
            <FaTwitter />
    ...
    <div className="w-full md:w-1/4 mb-6 md:mb-0">
      ...
      <ul className="space-y-2">
        ...
        <li><a href="#" className="hover:text-gray-400">Create account</a></li>
        <li><a href="#" className="hover:text-gray-400">Are you a Dealer?</a></li>
      </ul>
    </div>
    ...
    <div className="w-full md:w-1/4 mb-6 md:mb-0">
      ...
      <ul className="space-y-2">
        ...
        <li><a href="#" className="hover:text-gray-400">Shipping & Return Policy</a></li>

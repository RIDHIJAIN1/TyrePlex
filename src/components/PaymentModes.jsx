...
const PaymentModes = () => {
  return (
    ...
    <div className="w-full bg-black bg-opacity-70 my-10 shadow-md p-6 ">
      <h2 className="text-3xl lg:text-4xl font-bold text-center text-white m-10 pb-5">PAYMENT MODE</h2>
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 text-lg my-8 mx-20">
        <div className="flex justify-center">
          <div className="bg-white shadow-lg rounded-lg p-2  w-48 flex items-center">
